 ...
 * you should implement the ones provided. You may also find it useful to specify a method that returns the effects of a
 * StripsAction.
 */
public interface StripsAction
{
   ...
   *
   * @param state
   *          GameState to check if action is applicable
   ...
   *
   * As an example consider a Move action that moves peasant 1 in the NORTH direction. The partial game state might
   * specify that peasant 1 is at location (3, 3). The returned GameState should specify peasant 1 at location (3, 2).
   *
   * In the process of updating the peasant state you should also update the GameState's cost and parent pointers.
   *
   * @param state
   *          State to apply action to
